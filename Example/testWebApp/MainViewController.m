...
- (void)btnEvent{
    SanYueAppViewController *app = [[SanYueAppViewController alloc] initWithURL:@"http://172.16.0.243:3000/app.zip?dfafda" widthNeedDeBug:_isDebug withNetworkWatching:@"www.baidu.com"];
